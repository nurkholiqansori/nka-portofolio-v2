...
export const Nav = (props: Props) => {
  ...
  return (
    <>
      <div className='absolute -top-2 -left-2 bg-sky-800 w-28 h-28 rounded-br-full flex justify-center items-center z-50'>
        <div
      ...
      <div
        className={
          'transition-all duration-700 transform translate-y-0 translate-x-0 rounded-none ' +
          (show
            ? 'ease-in'
