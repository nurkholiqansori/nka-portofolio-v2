  ...
  return (
    <div className='w-full'>
      <div className='flex'>
        ...
        <div className='pb-8 '>
          <p className='mb-2 text-xl font-bold text-white dark:text-gray-300'>
            Education
          </p>
      ...
      <div className='flex'>
        ...
        <div className='pt-1'>
          <p className='mb-2 text-lg font-bold text-white dark:text-gray-300'>
            Courses
          </p>
          <div className='text-white dark:text-gray-300 grid gap-5 ml-1 md:grid-cols-3 xl:grid-cols-4'>
            {data.skill.map((i) => (
